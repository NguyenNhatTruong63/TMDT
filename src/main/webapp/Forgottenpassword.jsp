...
<div id="account-login" class="container">
    ...
    <div class="row">
        ...
        <div id="content" class="col-sm-9">
            ...
            <p>Nhập địa chỉ e-mail được liên kết với tài khoản của bạn. Nhấn vào tiếp tục để nhận lại mật khẩu của bạn
                trong e-mail đã đăng ký</p>
            <form action="SendMail" method="post" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" value="" placeholder="Địa chỉ email" id="input-email"
                                   class="form-control">
                        </div>
                    </div>
                </fieldset>
