            ...
            <form action="" method="post">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td class="text-center"><a href="Product?id=<%=product.getId()%>"><img
                                    src="<%=product.getImages().get(0)%>" alt="thatlung" title="thatlung"
                                    class="img-thumbnail"></a></td>
                            <td class="text-left"><a href="Product?id=<%=product.getId()%>"><%=product.getName()%>
                            </a>
                                <br>
                            </td>
                            <td class="text-left"><%=product.getId()%>
                            </td>
                            <td class="text-left">
                                <div class="input-group btn-block" style="max-width: 200px;">
                                    <input type="number" name="quantity" value="<%=cart.getCart().get(id)%>" min="1"
                                           size="1"
                            ...
                            <td class="text-right"><%=currencyFormatter.format(product.getPrice_buy())%>&nbsp;VNĐ</td>
                ...
                <div class="col-sm-4 col-sm-offset-8">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-right cart-total-price"><%=currencyFormatter.format(sumTotal)%>&nbsp;VNĐ</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
