  ...
  <div id="myaccount" class="container">
    ...
    <div class="row">
      ...
      <div id="content" class="col-sm-6">
        ...
        <a href="EditAccount.jsp"><p>Chỉnh sửa thông tin tài khoản</p></a>
        <a href="Changepassword.jsp"><p>Thay đổi mật khẩu tài khoản</p></a>
        <a href="AddProduct.jsp"><p>Đăng bài</p></a>
        <br>
        <h1>ĐƠN ĐẶT HÀNG</h1>
        <a href="Cart">
