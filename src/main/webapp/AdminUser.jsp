                        ...
                        <div class="col-lg-4 col-xl-3">
                            <div class="profile-content-left profile-left-spacing">
                                <div class="text-center widget-profile px-0 border-0">
                                    <div class="card-body">
                                        <h4 class="py-2 text-dark"><%=account.getFullName()%>
                                        </h4>
                                        <p style="white-space: nowrap;"><%=account.getUsername()%>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between ">
                                    <div class="text-center pb-4">
                                        <h6 class="text-dark pb-2"><%=list.size()%>
                                        </h6>
                                        <p>Đơn hàng đã mua</p>
                                    </div>
                                </div>
                                ...
                                <ul class="nav nav-tabs px-3 px-xl-5 nav-style-border" id="myProfileTab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="profile-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="profile" aria-selected="true">Hồ sơ
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="settings-tab" data-bs-toggle="tab"
                                                data-bs-target="#settings" type="button" role="tab"
                                                aria-controls="settings" aria-selected="false">Chỉnh sửa
                                        </button>
                                    </li>
                                </ul>
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="media widget-media p-3 bg-white border">
                                                        ...
                                                        <div class="media-body align-self-center">
                                                            <h4 class="text-primary mb-2"><%=list.size()%>
                                                            </h4>
                                                            <p>Đơn hàng đã mua</p>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="media-body pr-3 ">
                                                                    <a class="mt-0 mb-1 font-size-15 text-dark"
                                                                       href="#">Đơn hàng mới. Tình
                                                                        trạng: <%=order.getStatus()%>
                                                                    </a>
                                                                    <p><%=account.getFullName()%> đã đặt 1 đơn hàng
                                                                        mới</p>
                                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="settings" role="tabpanel"
                                        ...
                                        <div class="tab-pane-content mt-5">
                                            <form action="AdminEditUser?id=<%=account.getUsername()%>" , method="post">
                                                ...
                                                <div class="form-group mb-4">
                                                    <label>Email</label>
                                                    <label class="form-control"><%=account.getUsername()%>
                                                    </label>
                                                </div>
                                                <div class="form-group mb-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <label class="radio-inline">
                                                            <input type="radio" name="sex"
                                                                   value="1" <% if (account.getSex() == 1) {%>
                                                                   checked="checked"<%}%>/>
                                                            Nam</label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="sex"
                                                                   value="0" <% if (account.getSex() == 0) {%>
                                                                   checked="checked"<%}%>/>
                                                            Nữ</label>
                                                    </div>
                                                    ...
                                                    <br>
                                                    <div>
                                                        <label class="col-sm-2 control-label">Kích hoạt tài
                                                            khoản</label>
                                                        <div class="col-sm-10">
                                                            <label class="radio-inline">
                                                                <input type="radio" name="enabled"
                                                                       value="1" <% if (account.getEnable() == 1) {%>
                                                                       checked="checked"<%}%>/>
                                                                Có</label>&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <label class="radio-inline">
                                                                <input type="radio" name="enabled"
                                                                       value="0" <% if (account.getEnable() == 0) {%>
                                                                       checked="checked"<%}%>/>
                                                                Không</label>
                                                        </div>
                                                    </div>
