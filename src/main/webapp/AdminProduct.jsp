                                    ...
                                    <div class="col-xl-5 col-lg-6">
                                        <div class="row product-overview">
                                            <div class="col-12">
                                                ...
                                                <br>
                                                <p class="product-price">Mã sản phẩm: <%=product.getId()%>
                                                </p>
                                                <p class="product-price">Thương hiệu: <%=product.getBrand()%>
                                                </p>
                                                <p class="product-price">Loại sản
                                                    phẩm: <% if (product.getCategory() == 1) { %>
                                                    Mặt thắt lưng
                                                ...
                                                <p class="product-price">Số lượng còn lại: <%=product.getQuantity()%>
                                                </p>
                                                <p class="product-price">Số lượng đã bán: <%=product.getProduct_sold()%>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
