        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <fieldset>
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-address-1">Số điện thoại</label>
                <div class="col-sm-10">
                  <input type="tel" name="phone" value="" placeholder="Số điện thoại" id="input-address-1" class="form-control" required>
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  <% ProductDao dao = new ProductDao();
                    ...
                    <td class="text-right"><%=currencyFormatter.format(product.getPrice_buy())%></td>
                  ...
                  <tr>
                    ...
                    <td class="text-right"><%=currencyFormatter.format(cart.getTotalSum()+30000)%>&nbsp;VNĐ</td>
                  </tr>
                  <tr>
