    ...
    <div class="row">
        ...
        <div id="content" class="col-sm-9">
            ...
            <div class="table-responsive">
                <form action="HistoryOrder" method="get">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-left"><%=o.getFullname()%>
                            </td>
                            <td class="text-center"><%=o.getNumber()%>
                            </td>
                            <td class="text-left"><%=o.getStatus()%>
                            </td>
                            <td class="text-right"><%=o.getTotal()%>
                            </td>
                            <td class="text-left"><%=o.getDate().toString()%>
                            </td>
                            <% if (o.isVerifyData()) { %>
                            <td class="text-center" style="color: #20a278; font-weight: bold"><%=o.isVerifyData()%>
                            </td>
                            <% } else { %>
                            <td class="text-center" style="color: #ff0000; font-weight: bold"><%=o.isVerifyData()%>
                            </td>
                            <% }
                                if (o.isVerifyOwner()) { %>
                            <td class="text-center" style="color: #20a278; font-weight: bold"><%=o.isVerifyOwner()%>
                            </td>
                            <% } else { %>
                            <td class="text-center" style="color: #ff0000; font-weight: bold"><%=o.isVerifyOwner()%>
                            </td>
                            <% } %>

                            <td class="text-right"><a href="OrderDetail?id=<%=o.getId()%>" data-toggle="tooltip"
                                                      title="" class="btn btn-info" data-original-title="View"><i
