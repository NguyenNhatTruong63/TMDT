            ...
            <div class="content">
                <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="breadcrumbs"><span><a href="AEditProduct?idpd=<%=product.getId()%>">Trang chủ</a></span>
                            ...
                            <div class="card-body product-detail">
                                <form action="AdminUpdateProduct?idpd=<%=product.getId()%>" method="post">
                                        ...
                                        <div class="col-xl-5 col-lg-6">
                                            <div class="row product-overview">
                                                <div class="col-12">
                                                    ...
                                                    <br>
                                                    <label for="lang-select" class="text-uppercase">Loại sản phẩm
                                    ...
                                    <div class="d-flex justify-content-end mt-5">
                                        <button type="submit" class="btn btn-primary mb-2 btn-pill">Cập nhật sản phẩm</button>
                                    </div>
                                </form>
                            </div>
