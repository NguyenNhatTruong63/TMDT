      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tr>
            ...
            <td class="text-right"><%=currencyFormatter.format(p.getTotal())%></td>
          </tr>
          <% } %>
          ...
          <tr>
            ...
            <td class="text-right"><%=currencyFormatter.format(order.getTotalship())%>&nbsp;VNĐ</td>
            <td></td>
          </tr>
          <tr>
            <td colspan="3"></td>
            <td class="text-right"><b>Tổng cộng</b></td>
            <td class="text-right"><%=currencyFormatter.format(order.getTotal())%>;VNĐ</td>
            <td></td>
          </tr>
          </tfoot>
