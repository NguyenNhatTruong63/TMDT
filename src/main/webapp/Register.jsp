...
<div id="account-register" class="container">
  ...
  <div class="row">
    ...
    <div id="content" class="col-sm-9">
      ...
      <p>Nếu bạn đã có tài khoản với chúng tôi, vui lòng đăng nhập tại trang <a href="Login.jsp">đăng nhập </a>.</p>
      <form action="../Register" method="post" class="form-horizontal" name="form1" onsubmit="return validation()">
        ...
        <div class="buttons">
          <div class="pull-right">Tôi đã đọc và đồng ý với <a href="privacypolicy.html"><b>Chính sách quyền riêng tư</b></a>
