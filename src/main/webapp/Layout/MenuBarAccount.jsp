        ...
        <div class="box-content">
            <div class="list-group">
                ...
                <ul class="list-unstyled">
                    ...
                    <a href="AddProduct.jsp" class="list-group-item">Đăng bài</a>
        ...
        <div class="box-content">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <a href="Deliveryinformation.jsp">Thông tin giao hàng</a>
                </li>
                <li>
                    <!-- link chinh sach bao mat -->
                    <a href="Privacypolicy.jsp">Chính sách bảo mật</a>
                </li>
                <li>
                    <!-- link dieu khoan va dieu kien -->
                    <a href="TermsAndConditions.jsp">Điều khoản và điều kiện</a>
                </li>
                <li>
                    <!-- link lien he chung toi -->
                    <a href="../AboutUs.jsp">Liên hệ chúng tôi</a>
                </li>
                <li></li>
            </ul>
        </div>
