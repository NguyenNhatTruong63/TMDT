...
<footer>
    ...
    <div class="footer-bottom clearfix">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="powered">Copyright ©<a href="https://www.facebook.com/yenvi.2201/">Vi</a></p>
                </div>
                <div class="col-md-6">
                    <div class="position-footer-bottom">
                        <div>
                            <div class="social-block">
                                <ul>
                                    <li><a href="https://www.facebook.com/yenvi.2201/"><i style="margin-top: 10px" class="fa-brands fa-facebook"></i></a></li>
                                    <li><a href="https://www.youtube.com/channel/UCWKTeKUQS3TxUuwOLHOpung"><i style="margin-top: 10px"
                                            class="fa-brands fa-youtube"></i></a></li>
                                    <li><a href="#"><i style="margin-top: 10px" class="fa-brands fa-google"></i></a></li>
                                    <li><a href="https://github.com/nguyenthiyenvi20130463"><i style="margin-top: 10px"
...
<a href="#" class="scrollToTop back-to-top"><i style="margin-top: 10px" class="fa-solid fa-angles-up"></i></a>